...
def main():
    ...
    st.caption("Versión 2.6 selector simple por funcionario · SEREMI de Salud Región Metropolitana · Departamento de Acción Sanitaria · Sección Gestión Ambiental")

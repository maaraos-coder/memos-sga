...
.logo-wrap img {{max-width: 150px !important; height:auto !important; display:block; margin:auto;}}
.main-title {{
    font-size: 2.05rem;
    line-height: 1.15;
    font-weight: 850;
...
@media (max-width: 900px) {{
    ...
    .logo-wrap img {{max-width: 128px !important;}}
...
def mostrar_inicio():
    ...
    col_logo, col_title = st.columns([0.9, 3.6], vertical_alignment="center")
    with col_logo:
        if LOGO_PATH.exists():

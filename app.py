...
def page_generar():
    ...
    if generar:
        if dest_label == "Seleccione destinatario...":
            ...
            """, unsafe_allow_html=True)
            st.info("La materia y el destinatario quedaron limpios para generar otro documento.")
...
def main():
    ...
    st.caption("Versión 2.8 botones azules institucionales · SEREMI de Salud Región Metropolitana · Departamento de Acción Sanitaria · Sección Gestión Ambiental")

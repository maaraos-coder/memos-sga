...
def page_generar():
    ...
    <div class="panel" style="margin-top:0;">
        ...
        <div class="small-muted" style="margin-top:8px;">El funcionario se registra automáticamente según el usuario que inició sesión.</div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with st.form("generar_documento_form", clear_on_submit=True):
        ...
        dest_options = ["Seleccione destinatario..."] + dest_labels
        dest_label = st.selectbox("Destinatario", dest_options, index=0, key="destinatario_generar_select")
    ...
    if generar:
        if dest_label == "Seleccione destinatario...":
            st.warning("Debe seleccionar un destinatario.")
...
def main():
    ...
    st.caption("Versión 3.0 optimizada · SEREMI de Salud Región Metropolitana · Departamento de Acción Sanitaria · Sección Gestión Ambiental")
